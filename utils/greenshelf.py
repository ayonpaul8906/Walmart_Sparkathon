...
# Load CSV
df = pd.read_csv(r"data/simulated_freshtrack_data_5000.csv")
...
# Save model
joblib.dump(ml_model, "data/freshtrack_spoilage_model.pkl")

# Save label encoders too (needed during prediction)
joblib.dump(le_sku, "data/le_sku_encoder.pkl")
joblib.dump(le_cat, "data/le_category_encoder.pkl")
...
import joblib
ml_model = joblib.load("data/freshtrack_spoilage_model.pkl")
le_sku = joblib.load("data/le_sku_encoder.pkl")
le_cat = joblib.load("data/le_category_encoder.pkl")
